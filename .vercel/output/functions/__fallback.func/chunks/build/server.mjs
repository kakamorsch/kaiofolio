...
import { p as parseURL, e as encodePath, k as decodePath, l as hasProtocol, m as isScriptProtocol, h as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch, o as defu, q as createHooks, c as createError$1, r as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B888bN1F.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Kdt-8G4c.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CxIeuxXp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DJ2qOf7X.mjs'));
