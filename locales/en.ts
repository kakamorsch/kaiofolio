    ...
    experiences: [
      {
        ...
        location: 'Brazil',
        description:
          'At Dot Digital Group—a leader in corporate education that transforms learning for Fortune 500 companies—I turn Figma designs into high-performance Vue.js applications.',
        highlights: [
      ...
      },
      {
        ...
        location: 'Brazil',
        description:
          'Designing and developing a comprehensive e-commerce and inventory management system from the ground up, handling complex state management and high-concurrency data flows.',
        highlights: [
      ...
      },
      {
        ...
        description:
          'Architected and maintained critical payment gateway flows, ensuring transaction idempotency and high availability.',
        highlights: [
