  ...
  <section id="experiencias" class="relative py-24 md:py-32 px-4" :aria-label="$t('a11y.sectionExperience')" tabindex="-1">
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div>
        ...
        <!-- Featured Case Study -->
        <div v-if="filteredExperiences.length > 0" class="relative bg-cyber-card border border-dashed border-cyber-accent-secondary/40 cyber-chamfer p-6 md:p-8 mt-6">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
